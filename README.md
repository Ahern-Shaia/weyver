...
| **⭐ 13** | **[產品開發功能順序表](docs/13-產品開發功能順序表.md)** | ✅ **2026-07-19 v1.5**(**buildable sprint 順序**|Phase 1 Ragic 229 → Phase 2 ERP +203 → Phase 3 MES/ISO +40 = 472;**v1.5 §3.1 P0-1 後端核心 SHIPPED**(設計器 UI 未接);v1.4 §3/§4 Ragic-parity release 重編;dependency + Ragic-first M18 + risk gates)|
...
| **⭐ 23** | **[產品功能發布藍圖(客戶版)](docs/23-產品功能發布藍圖.md)** | ✅ **2026-07-19 v6.2**(**§1.6 開發啟動狀態:Phase 1 工程起跑,R1 命門(表單引擎核心)已交付並通過隔離/壓測驗證,時程承諾不變**;Ragic-parity-first:R1 完整 Ragic(~229,含 AI 建表/NL/ZEN)→ R2 ERP+計算層(+~203)→ R3 MES+ISO(+~40,完整 MVP)→ R4 對標+AI;solo 務實 R1 ~2-2.5 年 / R3 ~4-4.5 年)|
