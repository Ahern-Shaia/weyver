...
| **OQ-TPL-8** | R1 要放幾個、放什麼 | A. 3–8 個高信賴度官方範本<br>B. 20+ 廣覆蓋 | **A,且優先食品加工情境**:進貨驗收 · 每日清潔紀錄 · CCP 監控 · 訂便當。**範本的價值在背書不在數量** —— 對不會寫程式的使用者,10 個看不懂的範本比 3 個他認得的更糟 |
