...
| | |
|---|---|
| 狀態 | ✅ **SHIPPED v1.1(2026-08-07;M6 安裝紀錄)** · v1.0(2026-08-03;M1–M5)|OQ-TPL-1..10 全採建議。⚠️ 視圖與條件式格式**刻意未帶**(見 §4-ter,是「先不做」不是「做不到」)|
| 建立 | 2026-08-03 |
