...
| 模組 | 研究強度 | 可回查出處 | 逐字 | Ragic doc | 其他來源 | 文件 |
|---|---|---|---|---|---|---|
| [F-2] 認證 + 租戶 context + 使用者身分 | ⭐ 有一手依據 | 22 | 0 | — | ASVS · Better Auth · CVE-2025-61928 · CVE-2025-64484 · CVE-2026-35051 · CVE-2026-53513 · CVE-2026-53514 · Fastify · NestJS · OWASP | [foundation/auth.md](foundation/auth.md) |
| [F-5] 檔案儲存基礎設施(上傳 / 下載 / 附件欄完成) | ⭐ 有一手依據 | 15 | 0 | — | Airtable · CVE-2025-24033 · CVE-2026-25223 · CVE-2026-33806 · CVE-2026-3635 · ClamAV · Fastify · NestJS · OWASP | [foundation/file-storage.md](foundation/file-storage.md) |
| [F-9] 框架升版(NestJS 11 + Fastify 5) | ⭐⭐ 深且推翻過 | 37 | 1 | — | Better Auth · CVE-2025-32442 · CVE-2026-25223 · CVE-2026-33806 · CVE-2026-3635 · ClamAV · Fastify · NestJS | [foundation/framework-upgrade.md](foundation/framework-upgrade.md) |
| [F-7] 影像處理(EXIF 剝除 / 縮圖 / HEIC) | ⭐⭐ 深且推翻過 | 15 | 5 | `148` | Airtable · Baserow · Teable | [foundation/image-processing.md](foundation/image-processing.md) |
| [F-11] 上傳掃毒 + presigned 混合下載 | ⭐⭐ 深且推翻過 | 28 | 0 | — | CVE-2020-7613 · CVE-2025-20128 · CVE-2025-20234 · CVE-2025-20260 · CVE-2026-20213 · ClamAV · OWASP | [foundation/malware-scanning.md](foundation/malware-scanning.md) |
| [F-4] 二步驟驗證(MFA / TOTP) | ⭐⭐ 深且推翻過 | 15 | 1 | — | Better Auth · OWASP · Salesforce | [foundation/mfa.md](foundation/mfa.md) |
| [F-6] 平台可靠性工程(冪等性 / 資源配額 / metadata 車道 RLS 兜底 / 清理 job) | ⭐ 有一手依據 | 17 | 3 | — | NestJS · Stripe | [foundation/reliability.md](foundation/reliability.md) |
| [F-10] 分頁級租戶上下文(修跨分頁污染) | ⭐ 有一手依據 | 13 | 3 | — | Better Auth · Notion · OWASP · Shopify | [foundation/tenant-context.md](foundation/tenant-context.md) |
| [R1·後續-1] 自訂按鈕 + 簽核流程(workflow UX 面) | ⭐⭐ 深且推翻過 | 22 | 0 | `13` `15` `68` | Airtable · NestJS · Odoo · SAP · Salesforce · ServiceNow · Teable | [R1/actions-approval.md](R1/actions-approval.md) |
| [R1·AI-1] AI 設定(BYO key)+ 遷移建表助手 | ⭐⭐ 深且推翻過 | 25 | 12 | `82` `151` `176` `177` | Airtable · GDPR | [R1/ai-assist.md](R1/ai-assist.md) |
| [R1·後續-1b] 簽核進階語意(動態簽核人 / 會簽擇辦 / 加簽 / 退回 / 不可竄改) | ⭐⭐ 深且推翻過 | 28 | 11 | `13` `15` | Kissflow · Odoo · SAP · Salesforce · ServiceNow | [R1/approval-advanced.md](R1/approval-advanced.md) |
| [P0-4a·uplift] 資源軸繼承(分類授權 + owner + 敏感旗標) | ⭐⭐ 深且推翻過 | 11 | 11 | `0` `11` `32` | Airtable · Notion · Odoo · Salesforce | [R1/authz-resource-inheritance.md](R1/authz-resource-inheritance.md) |
| [P0-4a] 三層權限(授權層) | ⭐ 有一手依據 | 26 | 1 | `32` `64` | Airtable · Baserow · Better Auth · CVE-2019-11780 · CVE-2024-12368 · CVE-2024-36259 · NestJS · NocoDB · Odoo · Salesforce | [R1/authz.md](R1/authz.md) |
| [R1·UP-3b] 條件式格式(form-designer-2d P1 解鎖) | ⭐⭐ 深且推翻過 | 46 | 28 | `6` | Airtable · Baserow · NocoDB · Teable | [R1/conditional-format.md](R1/conditional-format.md) |
...
| [R1·#106] 匯入既有表單(upsert + 撤銷) | ⭐⭐ 深且推翻過 | 37 | 6 | `41` `65` `81` `91` `232` | Airtable · Baserow · NocoDB · Notion · Odoo · Salesforce · Shopify · Zoho | [R1/import-to-existing-form.md](R1/import-to-existing-form.md) |
| [R1·LNK] 連結欄選記錄 + Load 帶入 | ⭐ 有一手依據 | 8 | 8 | `14` | Airtable · Teable | [R1/link-picker-and-load.md](R1/link-picker-and-load.md) |
| [H-1] 通知系統(訂閱 / 提醒 / 通道) | ⭐⭐ 深且推翻過 | 25 | 4 | `5` `12` `32` `78` `94` `96` | Airtable · CVE-2019-11544 · CVE-2021-39119 · CVE-2021-41312 · Fastify · Notion · Teable | [R1/notifications.md](R1/notifications.md) |
| [R1·UP-4c] 選項顏色設定 UI(field-types-parity P1 解鎖) | ⭐⭐ 深且推翻過 | 11 | 6 | `6` `27` | Airtable · Baserow · NocoDB · Teable | [R1/option-colors.md](R1/option-colors.md) |
| [F-2] 樞紐分析 + 圖表 | ⭐⭐ 深且推翻過 | 108 | 27 | `7` `9` `22` `27` `32` `42` `58` `86` `90` `99` `122` `137` | Airtable · Baserow · CVE-2024-55951 · Metabase · NocoDB · Notion · Salesforce · Teable | [R1/pivot-and-charts.md](R1/pivot-and-charts.md) |
| [R1·後續-2] 標籤/QR 產生器 + 列印增強(合併列印為 P1) | ⭐ 有一手依據 | 40 | 6 | `4` `27` `40` `42` `53` `138` `149` | — | [R1/print-merge.md](R1/print-merge.md) |
| [G-2] 公開表單 | ⭐ 有一手依據 | 29 | 0 | `23` `32` `54` `110` `195` | Airtable · Baserow · ClamAV · OWASP | [R1/public-form.md](R1/public-form.md) |
| [R1·H-4] 記錄修改紀錄(誰、什麼時候、把什麼改成什麼) | ⭐⭐ 深且推翻過 | 12 | 7 | `81` | — | [R1/record-revisions.md](R1/record-revisions.md) |
...
| 模組 | 已出貨 | 研究強度 | 可回查出處 | Ragic doc | 文件 |
|---|---|---|---|---|---|
| 「宣稱 vs 使用者走得到的路徑」稽核(全 35 份) | — | ⭐⭐ 深且推翻過 | 33 | — | [_audit/claim-vs-reality-audit-D.md](_audit/claim-vs-reality-audit-D.md) |
| 稽核「**修補本身**」(audit-D 之後的 63 檔) | — | · 零星引用 | 15 | — | [_audit/fix-batch-audit-E.md](_audit/fix-batch-audit-E.md) |
| 「站在巨人的肩膀」稽核（第 A 批:連 §0 標題都沒有的 14 份) | — | ⭐⭐ 深且推翻過 | 39 | `4` `11` `21` `32` `37` `121` `149` `306` | [_audit/giants-shoulders-audit-A.md](_audit/giants-shoulders-audit-A.md) |
...
| [R1·UP-5] 前端視覺重構(落地 weyver-v3) | — | · 零星引用 | 6 | — | [R1/frontend-v3-refactor.md](R1/frontend-v3-refactor.md) |
...
| 模組 | 豁免理由 | 文件 |
|---|---|---|
| [F-8] 訂閱計費(**地基預留**,非實作) | 本模組的核心裁定是「**分開計費自動化與計費地基**」,而分界線是 | [foundation/subscription-billing.md](foundation/subscription-billing.md) |
