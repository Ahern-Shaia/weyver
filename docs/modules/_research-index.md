...
| 模組 | 研究強度 | 逐字 | Ragic doc | 其他來源 | 文件 |
|---|---|---|---|---|---|
| [R1·後續-1b] 簽核進階語意(動態簽核人 / 會簽擇辦 / 加簽 / 退回 / 不可竄改) | ⭐ 有一手依據 | 11 | `13` `15` | Odoo · Salesforce | [R1/approval-advanced.md](R1/approval-advanced.md) |
| [P0-4a·uplift] 資源軸繼承(分類授權 + owner + 敏感旗標) | ⭐ 有一手依據 | 11 | `0` `11` `32` | Airtable · Notion · Odoo · Salesforce | [R1/authz-resource-inheritance.md](R1/authz-resource-inheritance.md) |
| [R1·UP-3b] 條件式格式(form-designer-2d P1 解鎖) | ⭐ 有一手依據 | 28 | `6` | Airtable · Baserow · NocoDB · Teable | [R1/conditional-format.md](R1/conditional-format.md) |
| R1·I-1|資料匯出(帶得走的完整副本) | ⭐ 有一手依據 | 10 | — | ASVS · GDPR · OWASP · Salesforce | [R1/data-export.md](R1/data-export.md) |
| [R1·FMT] 日期輸入與顯示格式 | ⭐⭐ 三站齊全 | 15 | `51` | ARIA APG · Airtable · W3C | [R1/date-and-display-format.md](R1/date-and-display-format.md) |
| [E-1] 動態權限(記錄範圍 + 指派) | ⭐ 有一手依據 | 1 | `32` `54` | Airtable · Baserow · NocoDB · Notion · Odoo · Salesforce · Teable | [R1/dynamic-permissions.md](R1/dynamic-permissions.md) |
| [R1·A11Y] 欄位輸入的無障礙名稱 | ⭐ 有一手依據 | 2 | — | ARIA APG · Airtable · W3C | [R1/field-label-a11y.md](R1/field-label-a11y.md) |
| [R1·UP-4] 欄位型別 parity（form-engine-core 增量） | ⭐ 有一手依據 | 16 | `14` `20` `25` `27` `31` `145` `153` `295` `344` `357` | Airtable · Baserow · NocoDB · Notion · Odoo · Salesforce · Teable | [R1/field-types-parity.md](R1/field-types-parity.md) |
| [R1·UP-3] 2D 表單設計器（form-designer-ui uplift） | ⭐⭐ 三站齊全 | 24 | `21` `35` `121` `306` | Airtable · Baserow · NocoDB · Teable | [R1/form-designer-2d.md](R1/form-designer-2d.md) |
| [R1·UP-3c] 設計檢視 = 表單本身（設計器心智模型補完） | ⭐⭐ 三站齊全 | 12 | `21` `26` `34` `35` `37` `38` `53` `121` `306` | Airtable · Baserow · Teable | [R1/form-designer-wysiwyg.md](R1/form-designer-wysiwyg.md) |
| [R1·B-2] 表單範本庫 | ⭐ 有一手依據 | 3 | `37` `111` `176` `204` `268` | Airtable · Baserow · NocoDB · Notion · Salesforce · Teable | [R1/form-templates.md](R1/form-templates.md) |
| [P0-3] 公式引擎 + 關聯 Link&Load | ⭐ 有一手依據 | 10 | — | Airtable · Baserow · Glide Data Grid · NocoDB · Notion · Salesforce · Teable | [R1/formula-and-linkload.md](R1/formula-and-linkload.md) |
| [R1·UX-1] 前端重構(視覺 / 心智模型 / 操作體驗 / UI / UX) | ⭐⭐ 三站齊全 | 15 | — | ARIA APG · Airtable · Baserow · Glide Data Grid · NocoDB · Notion · Salesforce · W3C | [R1/frontend-uplift.md](R1/frontend-uplift.md) |
| [R1·P0-2 殘留] 網格貼上 Excel 區塊 | ⭐⭐ 三站齊全 | 15 | `107` `139` `210` | Airtable · Baserow · Glide Data Grid · Smartsheet · Teable | [R1/grid-paste.md](R1/grid-paste.md) |
| [R1·UP-4b] 圖片欄 + 簽名欄(field-types-parity P1 解鎖) | ⭐ 有一手依據 | 6 | `15` `27` | Airtable · Baserow · Teable | [R1/image-signature-fields.md](R1/image-signature-fields.md) |
| [R1·#106] 匯入既有表單(upsert + 撤銷) | ⭐ 有一手依據 | 6 | `41` `65` `81` `91` `232` | Airtable · Baserow · NocoDB · Notion · Odoo · Salesforce · Zoho | [R1/import-to-existing-form.md](R1/import-to-existing-form.md) |
| [R1·LNK] 連結欄選記錄 + Load 帶入 | ⭐⭐ 三站齊全 | 8 | `14` | Airtable · Teable | [R1/link-picker-and-load.md](R1/link-picker-and-load.md) |
| [H-1] 通知系統(訂閱 / 提醒 / 通道) | ⭐ 有一手依據 | 0 | `5` `12` `78` `94` `96` | Airtable · CVE-2019-11544 · CVE-2021-39119 · CVE-2021-41312 · Notion · Teable | [R1/notifications.md](R1/notifications.md) |
| [R1·UP-4c] 選項顏色設定 UI(field-types-parity P1 解鎖) | ⭐ 有一手依據 | 6 | `6` `27` | Airtable · Baserow · NocoDB · Teable | [R1/option-colors.md](R1/option-colors.md) |
| [F-2] 樞紐分析 + 圖表 | ⭐ 有一手依據 | 27 | `7` `9` `22` `27` `32` `42` `58` `86` `90` `99` `122` `137` | Airtable · Baserow · CVE-2024-55951 · Metabase · NocoDB · Notion · Salesforce · Teable | [R1/pivot-and-charts.md](R1/pivot-and-charts.md) |
| [R1·後續-2] 標籤/QR 產生器 + 列印增強(合併列印為 P1) | ⭐ 有一手依據 | 6 | `4` `27` `40` `42` `53` `138` `149` | — | [R1/print-merge.md](R1/print-merge.md) |
| [R1·H-4] 記錄修改紀錄(誰、什麼時候、把什麼改成什麼) | ⭐⭐ 三站齊全 | 7 | `81` | — | [R1/record-revisions.md](R1/record-revisions.md) |
| [R1·後續-2b] 伺服器端 PDF 與列印範本 | ⭐ 有一手依據 | 4 | `42` `56` `138` `284` | — | [R1/server-pdf.md](R1/server-pdf.md) |
| [R1·A-1] 設定中心(S22) | ⭐ 有一手依據 | 16 | `3` | ASVS · Airtable · CVE-2026-53514 · Notion · OWASP · Odoo · Salesforce | [R1/settings-center.md](R1/settings-center.md) |

## B. 其餘模組(引用較零星,承重前請自行複核)

| 模組 | 已出貨 | 研究強度 | Ragic doc | 文件 |
|---|---|---|---|---|
| 「宣稱 vs 使用者走得到的路徑」稽核(全 35 份) | — | ⭐ 有一手依據 | — | [_audit/claim-vs-reality-audit-D.md](_audit/claim-vs-reality-audit-D.md) |
| 稽核「**修補本身**」(audit-D 之後的 63 檔) | — | — | — | [_audit/fix-batch-audit-E.md](_audit/fix-batch-audit-E.md) |
| 「站在巨人的肩膀」稽核（第 A 批:連 §0 標題都沒有的 14 份) | — | ⭐⭐ 三站齊全 | `4` `11` `21` `32` `37` `121` `149` `306` | [_audit/giants-shoulders-audit-A.md](_audit/giants-shoulders-audit-A.md) |
| giants-shoulders-audit-B.md —— 已具 §0 研究節之 18 份模組文件稽核 | — | ⭐⭐ 三站齊全 | `6` `27` | [_audit/giants-shoulders-audit-B.md](_audit/giants-shoulders-audit-B.md) |
| 「站在巨人的肩膀」**複查**(全 33 份) | — | ⭐⭐ 三站齊全 | `27` `32` | [_audit/giants-shoulders-audit-C.md](_audit/giants-shoulders-audit-C.md) |
| [F-2] 認證 + 租戶 context + 使用者身分 | ✅ | — | — | [foundation/auth.md](foundation/auth.md) |
| [F-5] 檔案儲存基礎設施(上傳 / 下載 / 附件欄完成) | ✅ | — | — | [foundation/file-storage.md](foundation/file-storage.md) |
| [F-9] 框架升版(NestJS 11 + Fastify 5) | ✅ | — | — | [foundation/framework-upgrade.md](foundation/framework-upgrade.md) |
| [F-7] 影像處理(EXIF 剝除 / 縮圖 / HEIC) | ✅ | — | — | [foundation/image-processing.md](foundation/image-processing.md) |
| [F-11] 上傳掃毒 + presigned 混合下載 | ✅ | — | — | [foundation/malware-scanning.md](foundation/malware-scanning.md) |
| [F-4] 二步驟驗證(MFA / TOTP) | ✅ | — | — | [foundation/mfa.md](foundation/mfa.md) |
| [F-6] 平台可靠性工程(冪等性 / 資源配額 / metadata 車道 RLS 兜底 / 清理 job) | ✅ | — | — | [foundation/reliability.md](foundation/reliability.md) |
| [F-8] 訂閱計費(**地基預留**,非實作) | ✅ | — | — | [foundation/subscription-billing.md](foundation/subscription-billing.md) |
...
| [R1·C-4] 事件觸發器(建立 / 更新時自動執行) | — | ⭐⭐ 三站齊全 | `26` `29` `98` `125` `163` `173` `183` `185` `214` `260` `281` | [R1/event-triggers.md](R1/event-triggers.md) |
...
| [P0-2] 網格主檢視 + Excel 建表 onboarding | ✅ | · 零星引用 | `41` `54` `65` | [R1/grid-and-excel-import.md](R1/grid-and-excel-import.md) |
| [R1·H-5] 介面語言與**租戶自助翻譯** | — | ⭐⭐ 三站齊全 | `56` `84` | [R1/i18n.md](R1/i18n.md) |
| [G-2] 公開表單 | ✅ | · 零星引用 | `23` `32` `54` `110` `195` | [R1/public-form.md](R1/public-form.md) |
| [R1·workbench-uplift] 記錄工作台收斂(集合視圖 → Object Page) | ✅ | — | — | [R1/record-workbench-ui.md](R1/record-workbench-ui.md) |
| [H-2] 資源回收桶 + 保留期硬刪 | ✅ | · 零星引用 | `115` `124` | [R1/recycle-bin.md](R1/recycle-bin.md) |
| [F-1] 分組 / 看板 / 行事曆檢視 | ✅ | · 零星引用 | `9` `92` | [R1/views-group-kanban-calendar.md](R1/views-group-kanban-calendar.md) |
| [R1·UP-2] 視圖系統 + 集合(browse)視圖 | ✅ | · 零星引用 | `4` `15` `19` `38` `54` | [R1/views-list.md](R1/views-list.md) |
| [G-1] 事件匯流排 + 出站 Webhook + API 金鑰 | ✅ | — | — | [R1/webhook-and-events.md](R1/webhook-and-events.md) |
| [R1·A-2] 白牌:自訂網域 + 品牌客製 | — | ⭐⭐ 三站齊全 | `56` | [R1/white-label.md](R1/white-label.md) |
| [R1·UP-1] 工作區 IA(分類目錄首頁 + app-shell) | ✅ | · 零星引用 | `12` `17` `71` `90` `100` `119` | [R1/workspace-ia.md](R1/workspace-ia.md) |
| [R2 命門] 語意計算綁定層(自由表單 ↔ 算) | — | — | — | [R2/calc-binding-layer.md](R2/calc-binding-layer.md) |
