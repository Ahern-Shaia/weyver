...
| **三層權限(授權層)** | P0-4a | 🚧 **M0 APPROVED — OQ-AUTHZ-1..6 已裁定,M1 進行中**(表單級 RBAC + 欄位級遮罩 + **role tree 部門繼承**〔OQ-1=C,自 P1-I 前移〕;記錄級延 P1-I;deny-by-default;拆自 P0-4)| [R1/authz.md](R1/authz.md) |
