...
| 公式引擎 + Link&Load | P0-3 | 📝 **M0 DRAFT — 待裁定 OQ-FML-1..8**(含 OQ-FEC-7 fork Teable `packages/formula` MIT 決策;N+1 為頭號風險)| [R1/formula-and-linkload.md](R1/formula-and-linkload.md) |
