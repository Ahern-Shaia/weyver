...
@Module({
  ...
  controllers: [ButtonsController, ApprovalsController, ApprovalInboxController],
  providers: [ActionsRepository, ButtonService, ApprovalService, ApprovalLockInterceptor],
