...
| **⭐ 13** | **[產品開發功能順序表](docs/13-產品開發功能順序表.md)** | ✅ **2026-07-19 v1.4**(472 MVP 拆 sprint;dependency 圖;**v1.4 §3/§4 實體重編為 Ragic-parity release**|舊「Phase 0 混切 175/Phase 1 429」→ 執行 sprint 明細 + 各 sprint 標 Phase 1/2/3、§3.11/§4.11 release-mapped 對映 472(指示 sprint 加總 vs 權威 docs/04 v2.4)、§7 M18 改 Ragic-first;前 v1.3 docs/25 C1/C3 cascade)|
